...
for enzyme in enzymes:
    for chrom, sequence in raw_data.items():
        ...
        (centromere_sites, arm_sites, centromere_density, arm_density,
         centromere_mean_spacing, centromere_std_spacing, arm_mean_spacing, arm_std_spacing) = compute_density_and_spacing(chrom, cut_sites, bed_data)
